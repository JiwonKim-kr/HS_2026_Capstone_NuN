...
export function OptimizationResult({ originalPrompt, selectedCandidate, onRestart }: OptimizationResultProps) {
  ...
  const weightItems = [
    { label: t("optimization.w_tone"),       value: "+14%", width: "75%" },
    { label: t("optimization.w_level"),      value: "+22%", width: "85%" },
    { label: t("optimization.w_density"),    value: "+22%", width: "85%" },
    { label: t("optimization.w_creativity"), value: "+22%", width: "85%" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 w-full max-w-[1232px]">
        ...
        <div className="md:col-span-8 flex flex-col gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#003e93] text-[18px] tracking-[1.8px] uppercase">{t("optimization.selected")}</span>
          </div>

          <div className="mb-6">
            <h1 className="text-[48px] font-bold text-[#191c1e] tracking-[-2.4px] leading-[48px] mb-4 whitespace-pre-line">
          ...
          <div className="bg-white border border-[rgba(197,197,212,0.15)] rounded-xl shadow-sm p-8 flex flex-col gap-6">
            <div className="flex justify-between items-center w-full">
              <div className="bg-[#d9e2ff] px-3 py-1 rounded-full">
                <span className="text-[#001945] text-xs tracking-wide uppercase">{t("optimization.current_prompt")}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-[#f2f4f6] border-l-4 border-[#003e93] rounded-lg p-6">
                <p className="text-[#454652] text-[14px] leading-[28px] whitespace-pre-wrap">
                  {selectedCandidate?.content || t("optimization.no_content")}
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-2">
              ...
              >
                ...
                {isCopied ? t("optimization.copied") : t("optimization.copy")}
              </button>
            </div>
            ...
            {isCopied && (
              <div className="mt-2 pt-6 border-t border-[rgba(197,197,212,0.2)] flex flex-col sm:flex-row items-center justify-between gap-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                >
                  ...
                  <span className="font-medium text-[15px]">{isLiked ? t("optimization.feedback_done") : t("optimization.feedback_yes")}</span>
                </button>
              </div>
            )}
          </div>
        ...
        <div className="md:col-span-4 flex flex-col md:pl-2">
          <div className="bg-[#f2f4f6] border border-[rgba(197,197,212,0.15)] rounded-xl p-6 flex flex-col gap-6 sticky top-24 shadow-sm">
            ...
            <div className="flex gap-4 items-center mb-2">
              ...
              <h3 className="text-[20px] font-bold text-[#191c1e]">{t("optimization.weight_title")}</h3>
            </div>
