                ...
                visibleHistory.map((session) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex ${showLabels ? 'gap-3 px-4' : 'justify-center px-0'} items-center py-2.5 rounded-lg transition-colors w-full text-left ${isActive ? 'bg-gray-200 text-[#003e93]' : 'hover:bg-gray-200'
                        }`}
                      onClick={onMobileClose}
                    >
