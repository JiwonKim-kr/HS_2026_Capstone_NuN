...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#f8f9fb] flex flex-col">
      ...
      {/* 메인 컨텐츠 */}
      <main className="flex flex-1 items-center justify-center px-4 pt-[160px] pb-[100px]">
        <div className="w-full max-w-[448px] flex flex-col gap-[39.5px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
            ...
            <p className="text-center text-[14px] leading-[20px] text-[#757684]">
              아직 계정이 없으신가요?{" "}
              <Link href="/signup" className="text-[#3f51b5] font-semibold hover:underline">
                회원가입
              </Link>
            </p>
          </form>
